import dataset.utils_abide as Reader
import numpy as np
from lib.utils import preprocess_features
...
class Dataloader:
    ...
    def load_data(self, connectivity='correlation', atlas='ho'):
        ...
        self.raw_features = Reader.load_all_networks(subject_IDs, kind=connectivity, atlas_name=atlas)
    ...
    def get_PEWE_inputs(self, nonimg):
